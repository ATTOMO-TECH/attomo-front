...
export const Blogstyles = {
  Article: tw.article`flex flex-col items-end py-10 mx-auto md:flex-row justify-end px-8 lg:px-0 items-end `,
  BlockImg: tw.div`w-full lg:w-1/3 lg:max-w-lg md:w-1/2 cursor-pointer md:mr-8 lg:mr-0`,
