...
export const Button = {
  ButtonRegular: tw.p<Props>`
    text-Primary font-Primary font-light text-left text-lg pr-2
  ${(props) =>
  ...
  TextBack: tw.span`font-PrimarySans text-addictional font-light`,
};
...
export const Share = {
  ...
  ${(props) =>
    props.ismode === BUTTON_ACTIVE.ON
      ? 'w-4/6 h-auto delay-300 duration-300 ease-in-out opacity-100 fixed top-96 left-0'
      : 'w-0 overflow-hidden opacity-0 fixed -left-10  delay-100 duration-300 ease-in-out'}
`,
