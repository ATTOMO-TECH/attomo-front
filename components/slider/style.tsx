...
export const SelectedSlide = styled.label<Props>`
  ${({ active }) =>
    active
...
export const StylesArticle = {
  ...
  `,
  BlockArrow: tw.div`flex w-full text-xl  justify-center lg:justify-end lg:pr-32 mt-24`,
  ArrowPrev: tw.div`cursor-pointer   mr-5 `,
  ArrowNext: tw.div`cursor-pointer `,
