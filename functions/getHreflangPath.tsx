export const getENLangLink = (url: string): string => {
  ...
  else if (url === '/privacidad') alternativeUrl = '/privacy';
  else if (url === '/terminos') alternativeUrl = '/terms';
...
export const getESLangLink = (url: string): string => {
  ...
  else if (url === '/privacy') alternativeUrl = '/privacidad';
  else if (url === '/terms') alternativeUrl = '/terminos';
