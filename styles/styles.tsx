...
`,
  ...
  TextSecundary: tw.h6`text-primary font-light text-left text-sm p-4`,
  ListType: tw.li`w-full list-inside list-disc text-primary  text-left  p-2 text-sm font-light font-PrimarySerif tracking-wide leading-loose`,
  SectionMore: tw.div`flex  text-primary font-Primary underline text-left justify-center py-24 font-extralight text-xl`,
